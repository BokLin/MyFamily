//
//  MFRelationModel+CoreDataProperties.h
//  MyFamily
//
...
#import "MFRelationModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface MFRelationModel (CoreDataProperties)
...
@property (nullable, nonatomic, retain) MFPersonModel *person_from;
@property (nullable, nonatomic, retain) MFPersonModel *person_to;
