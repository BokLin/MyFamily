//
//  MFUser_MessageModel+CoreDataProperties.m
//  MyFamily
//
...
#import "MFUser_MessageModel+CoreDataProperties.h"

@implementation MFUser_MessageModel (CoreDataProperties)

@dynamic messageID;
@dynamic user_messageID;
@dynamic userID;
